...
class Application:
    ...
    def __init__(self):
        ...
        # Hide window until frontend button is clicked
        self.root.withdraw()
        self.check_signal()
    ...
    def check_signal(self):
        """Poll backend every 500ms - show window when button clicked"""
        try:
            import urllib.request
            import json
            with urllib.request.urlopen('http://localhost:3002/api/check_camera_signal', timeout=0.5) as r:
            ...
            pass
        self.root.after(500, self.check_signal)
